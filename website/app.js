...
const codeProject = [
  ...
  },
  {
    ...
    projText:
      "Small proof of concept game developed using just Javascript code with an HTML5 framework called Phaser. Most concepts used within this project are very Phaser specific but presented a fun alternative to typical useages with Javascipt. The game itself is a typical 'endless' jump style of game where carrots and platforms will continue to generate above the character as they jump, the goal is to get a high score without falling off the screen. If that happens, a game over will be presented and the user is prompted to restart. ",
...
const webProject = [
  {
    ...
    projText:
      "Proof of concept WordPress website built as a portfolio piece to experiment and for learning purposes. Implementing certain business needs, like a scheduling system in the case of this project, were made simpler with the use of WordPress when compared to creating a project from scratch.",
  ...
  },
  {
    ...
    projText:
      "Proof of concept WordPress website built as a portfolio piece to experiment and for learning purposes. Implementing certain business needs, like inventory and shop in the case of this project, were made simpler with the use of WordPress when compared to creating a project from scratch.",
  ...
  },
  {
    ...
    projText:
      "My personal portfolio! The video shows an old version of the site, this portfolio has served as a fun project to revisit as I learn new things or look to experiment over time. The site itself is created from scratch and uses just HTML, 800 plus lines of CSS (*) and Javascript code to achieve all the functionality. A few noteable functionalities on this site are the dynamic scrolling (after calculating screen position) from the NAV, the fixed NAV based on screen position, and querying for each of my projects from their objects then dynamically displaying them in the HTML with a function based on a selection.   *(CSS could be cleaner for sure!)*",
    projLink: "",
